...
class SRAction():
    ...
    '''
    Stare initiala: gata de transmitere data
    '''
    def Ready2Send(self):
        ...
        pass
    '''
    Trimite un mesaj din coada de mesaje
    '''
    def Send(self, i):
    ...
    def SendACK(self, i):
        ...
        pass
    '''
    Retrimitere, daca ACK nu a fost receptionat
    '''
    def Resend(self):
    ...
    def RecvACK(self, i):
        ...
        pass
    '''
    Receptioneaza urmatorul pachet
    '''
